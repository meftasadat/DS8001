...
7. To connect to rStudio server using your browser
   ...
   Now, Check the ip address of the VM using 
    ```ifconfig```
   Note the ip address (use the first one) and open a browser on your host machine. user the ip and port _8787_ as url to access rStudio server (i.e. 10.0.2.15:8787)
9. You can connect to Spark from rStudio with the sparklyr package (http://spark.rstudio.com/)
